...
\begin{exe}[4.19]
    ...
    Another possible solution would be to make the definitions lazy by 
    automatically delaying them, and forcing them only when a variable’s value 
    is looked up. This would be a big change to Scheme’s evaluation order 
    however.
\end{exe}
