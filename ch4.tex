...
\begin{exe}[4.32]
    ...
    instance, the following definition of \vscm{pairs} taken from 
    exercise~\ref{3.68}, where it caused an infinite loop, works for lazy lists:
    \scm{ch4/4.32a.scm}
    ...
    section~\ref{streams}, such as trees where all branches could potentially be 
    infinite.
\end{exe}
